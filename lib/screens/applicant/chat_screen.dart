...
class ApplicantChatScreen extends StatefulWidget {
  final String chatId;
  final String employerId;
  final String employerName;
  final String jobTitle;
  
  const ApplicantChatScreen({
    super.key,
  ...
  @override
  State<ApplicantChatScreen> createState() => _ApplicantChatScreenState();
}

class _ApplicantChatScreenState extends State<ApplicantChatScreen> with TickerProviderStateMixin {
  ...
  static const Color employerBubbleColor = Color(0xFFF0F9F0);
  ...
  PreferredSizeWidget _buildAppBar() {
    final employerInitial = widget.employerName.isNotEmpty 
    ...
    return AppBar(
      ...
      title: Row(
        children: [
          // Enhanced employer avatar with online indicator
          Stack(
            children: [
              Container(
                width: 44,
          ...
          if (isFromEmployer) ...[
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // Show timestamp above employer messages when tapped
  ...
  Widget _buildMessageStatusIcon(ChatMessage message) {
    switch (message.status) {
      ...
      case MessageStatus.sent:
        // Show "sent" status only briefly, then it disappears
        return Icon(
          Icons.check_rounded,
          size: 14,
      ...
      case MessageStatus.delivered:
        // Show "delivered" status (this is what user sees after "sent" disappears)
        return Icon(
