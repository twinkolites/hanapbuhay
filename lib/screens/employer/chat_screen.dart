...
class _EmployerChatScreenState extends State<EmployerChatScreen> {
  final TextEditingController _messageController = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  
  // Mock chat data from employer perspective
  ...
  Widget _buildMessageBubble(ChatMessage message, int index) {
    ...
    final showAvatar = !isFromEmployer && 
        (index == 0 || _messages[index - 1].isFromEmployer == true);
              ...
              children: [
                if (!isFromEmployer && showAvatar) ...[
                  Padding(
                    ...
                    child: Text(
                      message.applicantName ?? 'Applicant',
                      style: TextStyle(
                        color: darkTeal.withValues(alpha: 0.7),
                        fontSize: 11,
                        fontWeight: FontWeight.w600,
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isFromEmployer ? mediumSeaGreen : Colors.white,
                    borderRadius: BorderRadius.only(
                      topLeft: const Radius.circular(20),
                      topRight: const Radius.circular(20),
                      bottomLeft: Radius.circular(isFromEmployer ? 20 : 4),
                      bottomRight: Radius.circular(isFromEmployer ? 4 : 20),
                    ),
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: Text(
                    message.text,
                    style: TextStyle(
                      color: isFromEmployer ? Colors.white : darkTeal,
                      fontSize: 11,
                      height: 1.4,
                    ),
                  ),
                ...
                Padding(
                  padding: EdgeInsets.only(
                    left: isFromEmployer ? 0 : 8,
                    right: isFromEmployer ? 8 : 0,
                  ),
                  child: Text(
